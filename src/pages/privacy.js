		...
		<Layout>
			...
			<section>
				...
				<p>
					...
					Caio Gomes Dev respeitar a sua privacidade em relação a qualquer
					informação sua que possamos coletar no site{' '}
					<a href="https://caiogomes.dev">Caio Gomes Dev</a>, e outros sites
				...
				<p>
					...
					sectionulgação, cópia, uso ou modificação não autorizados.
				</p>{' '}
				<p>
				...
				<h2>Política de Cookies Caio Gomes Dev</h2>{' '}
				...
				<ul>
					...
					<li>
						...
						<br />
						<br /> Se você criar uma conta conosco, usaremos cookies
				...
				<ul>
					...
					<li>
						...
						para garantir que você forneça os anúncios mais relevantes
						sempre que possível, rastreando anonimamente seus
						interesses e apresentando coisas semelhantes que possam
					...
					<li>
						...
						nossos clientes acessaram o site através de um dos sites
						de nossos parceiros, para que possamos creditá-los
				...
				<p>
					Esta política é efetiva a partir de <strong>Agosto de</strong>
					<strong>2020</strong>.
				</p>
			</section>
